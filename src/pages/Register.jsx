...
import { Mail, Github, Linkedin, Eye, EyeOff, User, Lock, AlertCircle, ArrowLeft } from 'lucide-react';
...
const Register = () => {
    ...
    const { register, clearError, isLoading: authLoading } = useAuth();
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-300">
                        <div className="flex flex-col items-center space-y-2">
                            ...
                            <span className="text-xs">Customize your experience</span>
                        </div>
                        <div className="flex flex-col items-center space-y-2">
                ...
                <div className="mt-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="text-sm text-gray-700 dark:text-gray-300">Track your learning progress</span>
                        </div>
                        <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center">
                                <span className="text-green-600 dark:text-green-400 text-xs font-bold">✓</span>
                            </div>
                            <span className="text-sm text-gray-700 dark:text-gray-300">Save your progress to the cloud</span>
                        </div>
                        <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center">
                                <span className="text-green-600 dark:text-green-400 text-xs font-bold">✓</span>
